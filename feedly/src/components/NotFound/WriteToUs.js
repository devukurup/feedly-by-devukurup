...
const WriteToUs = () => {
    ...
    return ReactDOM.createPortal(
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 overflow-y-auto h-full w-full" onClick={() => setWriteToUsModal(false)}>
          <div className="relative top-48 mx-auto p-5 w-6/12 bg-white space-y-9 " onClick={(e) => e.stopPropagation()}>
        <div>
          <Typography style="h1">Can't find what you came for?</Typography>
          <Typography style="body2">Write to us about which category interests you and we will fetch them for for you daily, for free.</Typography>
        </div>
          ...
          <div className="space-x-2">
              ...
              <Button label="Cancel" style="text" onClick={()=> setWriteToUsModal(false)}/>
    ...
    // return (
    //     <div>
    //         <Modal className="w-80" isOpen={writeToUsModal} onClose={() => setWriteToUsModal(false)}>
    //             <Modal.Header>
    //                 <Typography style="h1">Can't find what you came for?</Typography>
    //                 <Typography style="body2">Write to us about which category interests you and we will fetch them for for you daily, for free.</Typography>
