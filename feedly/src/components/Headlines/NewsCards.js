        ...
        <div className="grid grid-cols-2">
          <div>
            <img
              ...
              src={"https://picsum.photos/seed/picsum/526/263"}
            />
          </div>

          <div>
            <div>
              <Typography style="h3" className="text-gray-600 text-justify">
                {" "}
                {headlines.title}{" "}
              </Typography>
            </div>
            ...
            <div className="pt-5">
              <Typography style="body2">
                {(headlines?.content?.length > length
                  ? headlines.content.substring(0, length)
                  : headlines.content) + "......"}
              </Typography>
            </div>
            ...
            <div className="pt-4">
              <Button
                ...
                onClick={() =>
                  history.push({
                    pathname: `/article/${headlines?.url.replace(
